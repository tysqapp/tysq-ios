//
//  SQGoldOrderListTableViewCell.swift
//  SheQu
//
...
class SQGoldOrderListTableViewCell: UITableViewCell {
    
    static let cellID = "SQGoldOrderListTableViewCellID"
    ...
    lazy var exchangePointsTitleLabel: UILabel = {
        ...
        exchangePointsTitleLabel.text      = "购买金币数："
