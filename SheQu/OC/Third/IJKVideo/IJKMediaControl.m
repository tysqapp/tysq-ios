...
- (void)awakeFromNib
{
    ...
    [self.fullScreenBtn setTitle:@"横屏" forState:UIControlStateNormal];
    [self.fullScreenBtn setTitle:@"竖屏" forState:UIControlStateSelected];
    [self.mediaProgressSlider setThumbImage:[UIImage imageNamed:@"sq_ijk_slider"] forState:UIControlStateNormal];;
...
- (void)refreshMediaControl
{
    ...
    self.rePlayBtn.hidden  = (self.mediaProgressSlider.value != self.mediaProgressSlider.maximumValue || isPlaying);
