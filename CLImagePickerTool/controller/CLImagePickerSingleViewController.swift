...
class CLImagePickerSingleViewController: CLBaseImagePickerViewController {
    ...
    @objc func initView() {
        ...
        self.rightBtn.setTitleColor(
            CLPickersTools.instence.tineColor,
            for: .normal
        )
        self.lookBtn.setTitleColor(
            CLPickersTools.instence.tineColor,
            for: .normal
        )
        self.resetBtn.setTitleColor(
            CLPickersTools.instence.tineColor,
            for: .normal
        )
        self.sureBtn.setTitleColor(
            CLPickersTools.instence.tineColor,
            for: .normal
        )
    ...
    deinit {
        debugPrint("CLImagePickerSingleViewController释放")
