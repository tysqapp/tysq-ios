...
class CLPickersTools {
    ...
    fileprivate func fetchAllSystemAblum() -> Void {
        ...
        debugPrint("智能\(smartAlbums.count)个")
        ...
        for i in 0..<smartAlbums.count {
            ...
            if collection.isKind(of: PHAssetCollection.classForCoder()) {
                ...
                debugPrint("\(String(describing: assetCollection.localizedTitle))相册,共有照片数:\(assetsFetchResults.count)")
    ...
    fileprivate func fetchAllUserCreatedAlbum() -> Void {
        ...
        debugPrint("用户创建\(topLevelUserCollections.count)个")
